...
module "vpc" {
  ...
  vpc_name = "shomotsu_production_vpc"
  env      = "production"
}
...
module "subnet" {
  ...
  public_subnets = {
    "subnet-1" = {
      ...
      tag_name          = "shomotsu_production_public-1a"
    },
    "subnet-2" = {
      availability_zone = "ap-northeast-1c"
      cidr_block        = "10.0.16.0/20",
      tag_name          = "shomotsu_production_public-1c"
    },
    "subnet-3" = {
      availability_zone = "ap-northeast-1d"
      cidr_block        = "10.0.32.0/20",
      tag_name          = "shomotsu_production_public-1d"
    }
  }  

  private_subnets = {
    "shomotsu_production_private-1a" = {
      availability_zone = "ap-northeast-1a",
      cidr_block        = "10.0.128.0/20",
      tag_name          = "shomotsu_production_private-1a"
    },
    "shomotsu_production_private-1c" = {
      availability_zone = "ap-northeast-1c"
      cidr_block        = "10.0.144.0/20",
      tag_name          = "shomotsu_production_private-1c"
    },
    "shomotsu_production_private-1d" = {
      availability_zone = "ap-northeast-1d"
      cidr_block        = "10.0.160.0/20",
      tag_name          = "shomotsu_production_private-1d"
    }
  }
}
...
module "igw" {
  ...
  vpc_id = module.vpc.vpc_id
  name   = "shomotsu_production_internet_gateway"
  env    = "production"
}
...
module "route_tables" {
  ...
  vpc_id                  = module.vpc.vpc_id
  public_route_table_name = "shomotsu_production_rtb_public"
  env                     = "production"
  private_route_tables = {
    shomotsu_production_private-1a = {
      Name = "shomotsu_production_rtb_private1_ap_northeast_1a"
    },
    shomotsu_production_private-1c = {
      Name = "shomotsu_production_rtb_private2_ap_northeast_1c"
    },
    shomotsu_production_private-1d = {
      Name = "shomotsu_production_rtb_private3_ap_northeast_1d"
    },
  }
}
...
module "ecr_repository" {
  ...
  repositories = {
    "nginx" = {
      ...
      name                 = "shomotsu_production_nginx_repository"
      tags                 = {
        Name = "shomotsu_production_nginx_repository"
    ...
    "laravel" = {
      image_tag_mutability = "IMMUTABLE"
      name                 = "shomotsu_production_laravel_repository"
      tags                 = {
        Name = "shomotsu_production_laravel_repository"
        Environment = "production"
      }
...
module "rds_subnet" {
  ...
  name        = "shomotsu_production_rds_subnet"
  description = "shomotsu production rds subnet"
  subnet_ids  = [for subnet in module.subnet.private_subnets : subnet.id]

  tags = {
    Name        = "Shomotsu production RDS Subnet Group"
    Environment = "production"
  }
}
...
module "rds" {
  ...
  identifier                  = "shomotsu-production-mysql-database"
...
module "elasticache_subnet" {
  ...
  name        = "shomotsu-production-elasticache-subnet"
  description = "shomotsu production elasticache subnet"

  subnet_ids = [for subnet in module.subnet.private_subnets : subnet.id]

  tags = {
    Name        = "Shomotsu production ElastiCache Subnet Group"
    Environment = "production"
  }
}
...
module "elasticache" {
  ...
  name = "shomotsu-production-serverless-cache"
  description = "shomotsu production serverless cache"
...
module "s3_bucket" {
  ...
  bucket_name = "shomotsu-production-bucket"

  tags = {
    Name        = "shomotsu-production-bucket"
    Environment = "production"
  }
}
...
module "cloudfront_oac" {
  ...
  name                              = "shomotsu-production-bucket.s3.ap-northeast-1.amazonaws.com"
  description                       = "shomotsu production oac"
...
module "cloudwatch_log" {
  ...
  name = "shomotsu-production-task-definition"
}
...
module "waf" {
  ...
  shomotsu_bucket_name = "shomotsu-production-log-bucket"
  cloudfront_bucket_name = "shomotsu-production-cloudfront-log-bucket"
  tags = {
    Environment = "production"
  }
}
...
module "ecs_cluster" {
  ...
  name = "shomotsu-production-ecs-cluster"
...
module "ecs_task_definition" {
  ...
  family_name = "shomotsu-production-task-definition"
  ...
  env_s3 = var.env_s3
  nginx_container_name = "shomotsu_production_nginx_repository"
  laravel_container_name = "shomotsu_production_laravel_repository"
...
module "ecs" {
  ...
  name       = "shomotsu_production_ecs_service"
